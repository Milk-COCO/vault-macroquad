...
async fn main() { 
    ...
    let mut button = Button::new(500.0, 80.0, "Clickity Clickity Click".to_string(), Color::new(0.5, 0.75, 0.5, 1.0), Color::new(0.05, 0.05, 0.1, 1.0), Color::new(0.05, 0.05, 0.1, 1.0), Color::new(0.5, 0.75, 0.5, 1.0), Some(poppins.clone()));
    ...
    loop {
        ...
        button.process((screen_width() / 2.0 - button.width() / 2.0, screen_height() / 2.0 - button.height() / 2.0 + 100.0));
        button.draw((screen_width() / 2.0 - button.width() / 2.0, screen_height() / 2.0 - button.height() / 2.0 + 100.0));
